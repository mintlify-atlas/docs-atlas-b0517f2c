---
title: "Terminal command reference for HagalazOS"
sidebarTitle: "Commands"
description: "Complete reference for all built-in HagalazOS terminal commands: help, time, echo, curl, ip, games, neofetch, gui, and luminsdk."
---
