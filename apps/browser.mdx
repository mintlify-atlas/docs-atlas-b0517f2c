---
title: "HagalazOS Browser app: web browsing with libcurl.js and Wisp"
sidebarTitle: "Browser"
description: "The HagalazOS Browser app runs in a draggable window and routes requests through libcurl.js and a Wisp WebSocket proxy to bypass browser CORS."
---
...
Standard browser `fetch()` enforces CORS — servers must opt-in by returning the right headers before a cross-origin request succeeds. The Browser app works around this by routing requests through a [Wisp](https://github.com/MercuryWorkshop/wisp-protocol) WebSocket server via libcurl.js.
